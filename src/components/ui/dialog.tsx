    ...
    return (
        <DialogPortal>
            ...
            <DialogPrimitive.Content
                ...
                onEscapeKeyDown={() => {
                    // Close on ESC if onClose is provided; otherwise, allow Radix to handle default closing via onOpenChange
                    if (onClose) {
                        onClose();
                    }
                    // If no onClose provided, do nothing here so default behavior proceeds
                }}
                className={cn(
