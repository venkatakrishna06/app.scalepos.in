...
/**
 * Skeleton loader for the User Management page
 *
 * This component displays a skeleton UI that mimics the structure of the User Management page
 * while the actual data is being loaded.
 */
export function UserManagementSkeleton() {
    // Create an array of 6 items to represent loading user cards
