...
export default function Menu() {
    ...
    const errorMessage = menuItemsErrorMessage || categoriesErrorMessage;
    if (error) {
        return (
                ...
                {viewMode === 'grid' ? (
                            ...
                            >
                                <div className="relative">
                                    <div className="relative w-full h-48 overflow-hidden bg-muted/30">
                                        ...
                                        />
                                        <div
                                            className="absolute bottom-3 left-3 bg-background/90 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-sm border">
                                ...
                                <CardHeader className="pb-2 pt-3">
                                    <div className="flex items-start justify-between">
                                        <CardTitle
                                            className="text-lg font-semibold line-clamp-1">{item.name}</CardTitle>
                                    </div>
                    ...
                    <div className="space-y-3">
                        {filteredItems.map((item) => (
                            ...
                            >
                                <div
                                    className="relative w-full sm:w-24 h-24 sm:h-24 flex-shrink-0 overflow-hidden rounded-md bg-muted/30">
                                    <img
                                        src={item.image}
                                        alt={item.name}
                ...
                <DialogContent className="sm:max-w-[600px]" onClose={() => {
                    ...
                    <div className="mt-4">
                        <MenuItemForm
                            ...
                            isSubmitting={createMenuItemMutation.isLoading || updateMenuItemMutation.isLoading}
