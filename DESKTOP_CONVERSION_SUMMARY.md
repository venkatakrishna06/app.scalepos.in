...
This document summarizes the changes made to convert the QuickQuick Restaurant Management System from a web application
to a desktop application using Electron.
